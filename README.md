...
[**Ver el dashboard en Power BI en línea**](https://bit.ly/3O00a7D)

[![alt text](https://imgur.com/kOZUgng.png)](https://bit.ly/3O00a7D)
...
| --- | :-: | --: |
| Longitudinal: Desde inicio de la pandemia al 27 de Diciembre del 2021 | Exploratorio | SQL- Power BI - R Markdown |
...
Para una mejor comprensión de los datos se construyó un dashboard dinámico en Power BI.  
Pruébalo [**AQUÍ**](https://bit.ly/3O00a7D)
